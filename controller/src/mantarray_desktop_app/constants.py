...
# Stimulation
STIM_MIN_ABSOLUTE_CURRENT_MICROAMPS = int(1e3)
STIM_MAX_ABSOLUTE_CURRENT_MICROAMPS = int(100e3)
# Tanner (1/6/26): not sure if this is correct, but voltage stim is not currently supported
STIM_MIN_ABSOLUTE_VOLTAGE_MILLIVOLTS = 10
STIM_MAX_ABSOLUTE_VOLTAGE_MILLIVOLTS = int(1.2e3)
STIM_MIN_OPTICAL_POWER_MILLIWATTS = 5
STIM_MAX_OPTICAL_POWER_MILLIWATTS = 40
...
# Stim Subprotocols
VALID_STIMULATION_TYPES = frozenset(["C", "V", "O"])

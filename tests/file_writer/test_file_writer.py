...
def test_FileWriterProcess__exits_status_function_correctly_when_newly_failed_files_errors_or_passes(
...
# def test_FileWriterProcess__processes_new_failed_upload_and_moves_zip_file_to_static_dir_w_cust_id(
...
#     mocker.patch.object(file_uploader.ErrorCatchingThread, "get_error", autospec=True, return_value="error")
...
#     put_object_into_queue_and_raise_error_if_eventually_still_empty(this_command, from_main_queue)
#     invoke_process_run_and_check_errors(file_writer_process)
#     file_writer_process._start_new_file_upload()
...
#     [True, False],
# )
# def test_FileWriterProcess__correctly_handles_when_file_upload_is_successful_and_auto_delete_is_true_or_false(
...
#     mocker.patch.object(file_uploader.ErrorCatchingThread, "is_alive", autospec=True, return_value=False)
#     mocker.patch.object(
#         file_uploader.ErrorCatchingThread, "get_upload_status", autospec=True
#     )

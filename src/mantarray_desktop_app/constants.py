...
SERIAL_COMM_SET_BIPHASIC_PULSE_COMMAND_BYTE = 16
SERIAL_COMM_START_STIMULATORS_COMMAND_BYTE = 17
SERIAL_COMM_STOP_STIMULATORS_COMMAND_BYTE = 18
...
SERIAL_COMM_MODE_CHANGED_BYTE = 0
SERIAL_COMM_MODE_UNCHANGED_BYTE = 1

...
STIM_MAX_PULSE_DURATION_MICROSECONDS = int(50e3)  # TODO rename
STIM_MIN_SUBPROTOCOL_DURATION_MICROSECONDS = int(100e3)
STIM_MAX_PULSE_CYCLE_DURATION_MICROSECONDS = STIM_MAX_PULSE_DURATION_MICROSECONDS + (
    2**32 - 1
)  # TODO rename, unit test?, also use to validate protocols in route?

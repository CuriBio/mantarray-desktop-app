...
CURRENT_BETA2_HDF5_FILE_FORMAT_VERSION = "1.2.0"
...
STIM_MAX_SUBPROTOCOL_DURATION_MICROSECONDS = 24 * 60 * 60 * int(1e3) * int(1e3)  # 24hrs

# Protocol Chunking  # TODO test these
STIM_MAX_CHUNKED_SUBPROTOCOL_DUR_MINS = 1
STIM_MAX_CHUNKED_SUBPROTOCOL_DUR_US = STIM_MAX_CHUNKED_SUBPROTOCOL_DUR_MINS * 60 * int(1e6)

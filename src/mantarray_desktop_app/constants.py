...
SERIAL_COMM_OFFSET_LENGTH_BYTES = 2
...
SERIAL_NUM_COMM_SENSORS_PER_WELL = 3
SERIAL_COMM_NUM_DATA_CHANNELS = SERIAL_NUM_COMM_SENSORS_PER_WELL * SERIAL_COMM_NUM_CHANNELS_PER_SENSOR
